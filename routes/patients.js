        ...
        .get(async (req, res, next) => {
            ...
            db.user.findAll({ 
                ...
                include: [{ 
                    ...
                    include: [
                        { model: db.doctor_operation_time, include: [
                            { as: 'doctor', model: db.user, attributes: ['id', 'first_name', 'last_name', 'profession', 'email'] },
                            { as: 'operation_time', model: db.operation_time },
                        ]},
